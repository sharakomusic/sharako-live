    ...
    ws.onmessage = function (ev) {
      ...
      if (type === "session.updated" || type === "session.created") {
        ...
        send({
          ...
          response: { instructions: "Greet once, softly: hello… Then stop and listen. Do not shout. Do not read instructions." }
        });
        ...
        try { playBytes(b64ToU8(String(msg.delta || msg.audio || ""))); } catch (_) {}
